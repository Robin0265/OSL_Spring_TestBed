...
from Vision.video_reading import test, CircleAnnotator, CircleTracker
import os.path
...
def main(cal_folder,inner_mask,outer_mask):
    ...
    if not os.path.exists('blue_cal.csv') or not os.path.exists('red_cal.csv'):
        ...
        test(file = cal_folder + '/camera_calibration_spring_test.h264',
...
if __name__ == '__main__':
    ...
    main(cal_folder=folder,
        inner_mask = "inner_mask3.png", #None, #folder+'inner_mask0826.png',
        outer_mask = "outer_mask3.png" #None, #folder+'outer_mask0826.png',
        )
